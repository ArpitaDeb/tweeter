...
$(document).ready(function () {
    ...
    $('form').on('submit', function (event) {
        ...
        if (tweetText === "" || tweetText === null) {
            $(".error-message").append('<i class="fa fa-exclamation-triangle" aria-hidden="true"></i><span>Please post some message, do not leave blank</span><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>');
        ...
        if (textLength > 0 && textLength <= maxMsgLen) {
